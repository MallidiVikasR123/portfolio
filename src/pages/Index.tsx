  ...
  return (
    <main className="relative min-h-screen pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-purple-500/10 dark:bg-purple-500/20 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 dark:bg-blue-500/20 rounded-full filter blur-3xl"></div>
      </div>

      {/* Hero Section */}
      <section 
        ref={containerRef}
        className="container px-6 pt-10 pb-16 md:pt-20 md:pb-24 flex flex-col justify-center items-center min-h-[calc(100vh-5rem)]"
      >
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-on-scroll">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 animate-fade-in opacity-0" style={{ animationDelay: "0.6s", animationFillMode: "forwards" }}>
          ...
          <div className="flex justify-center gap-4 pt-6 animate-fade-in opacity-0" style={{ animationDelay: "0.8s", animationFillMode: "forwards" }}>
            <a 
